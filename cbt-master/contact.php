...
<body class="w3-black">
    <nav class="w3-sidebar w3-bar-block w3-small w3-center">
        <img src="images/ultimategym_logo.png" style="width:100%"> <a class="w3-bar-item w3-button w3-padding-large w3-hover-black" href="home.php"><i class="fa fa-home w3-xxlarge"></i>
    ...
    <div class="w3-padding-large" id="main">
        <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
            ...
            <div class="w3-section">
                <p><i class="fa fa-map-marker fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Smk Wikrama Kota Bogor</p>
                <p><i class="fa fa-phone fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Phone: +62 859 4637 0960/p>
                <p><i class="fa fa-envelope fa-fw w3-text-white w3-xxlarge w3-margin-right"></i> Email: naufalhabibi@smkwikrama.sch.id</p>
            </div>
            <br>
